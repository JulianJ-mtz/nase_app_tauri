...
import { exportProduccionPorCliente } from "@/lib/csvExport";
...
export const ProductionByClientChart = ({ data }: ProductionByClientChartProps) => {
    const handleExport = async () => {
        await exportProduccionPorCliente(data);
    };

    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-semibold">Producción por Cliente</h2>
