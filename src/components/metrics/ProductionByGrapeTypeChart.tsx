...
import { exportProduccionPorTipoUva } from "@/lib/csvExport";
...
export const ProductionByGrapeTypeChart = ({ data }: ProductionByGrapeTypeChartProps) => {
    const handleExport = async () => {
        await exportProduccionPorTipoUva(data);
    };

    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-semibold">Producción por Tipo de Uva</h2>
